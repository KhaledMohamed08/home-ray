<x-site.template>
    <div class="page-banner overlay-dark bg-image" style="background-image: url({{asset('SiteAssets/assets/img/bg_image_1.jpg')}});">
                        ...
                        <div class="col-sm-6 py-3">
                            <div class="card-blog">
                                <div class="header">
                                    ...
                                    <a href="blog-details" class="post-thumb">
                                        <img src="{{asset('SiteAssets/assets/img/blog/blog_4.jpg')}}" alt="">
                                    </a>
                                </div>
                                <div class="body">
                        ...
                        <div class="col-sm-6 py-3">
                            <div class="card-blog">
                                <div class="header">
                                    ...
                                    <a href="blog-details" class="post-thumb">
                                        <img src="{{asset('SiteAssets/assets/img/blog/blog_5.jpg')}}" alt="">
                                    </a>
                                </div>
                                <div class="body">
